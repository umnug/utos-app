...
namespace UtahOpenSource.UWP
{
    ...
    public sealed partial class MainPage
    {
        public MainPage()
        {
            ...
            UtahOpenSource.Clients.UI.RootPageWindows.IsDesktop = AnalyticsInfo.VersionInfo.DeviceFamily == "Windows.Desktop";
            LoadApplication(new UtahOpenSource.Clients.UI.App());
