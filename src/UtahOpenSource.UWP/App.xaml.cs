...
namespace UtahOpenSource.UWP
{
    ...
    sealed partial class App : Application
    {
        ...
        private async Task InitNotificationsAsync()
        {
            ...
            var storeManager = Xamarin.Forms.DependencyService.Get<IStoreManager>() as UtahOpenSource.DataStore.Azure.StoreManager;

            if (storeManager == null)
                return;

            await storeManager.InitializeAsync();
            await UtahOpenSource.DataStore.Azure.StoreManager.MobileService.GetPush().RegisterAsync(channel.Uri);
        }
        ...
        protected async override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                assembliesToInclude.Add(typeof(UtahOpenSource.Clients.Portable.Settings).GetTypeInfo().Assembly);
                assembliesToInclude.Add(typeof(UtahOpenSource.Clients.UI.AboutPage).GetTypeInfo().Assembly);
                assembliesToInclude.Add(typeof(UtahOpenSource.DataStore.Abstractions.ICategoryStore).GetTypeInfo().Assembly);
                assembliesToInclude.Add(typeof(UtahOpenSource.DataStore.Azure.CategoryStore).GetTypeInfo().Assembly);
                assembliesToInclude.Add(typeof(UtahOpenSource.DataStore.Mock.CategoryStore).GetTypeInfo().Assembly);
                assembliesToInclude.Add(typeof(UtahOpenSource.Clients.Portable.FavoriteService).GetTypeInfo().Assembly);
