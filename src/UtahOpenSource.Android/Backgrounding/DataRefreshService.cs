...
using Xamarin.Forms;
using UtahOpenSource.Clients;
using UtahOpenSource.Clients.Portable;
using UtahOpenSource.DataStore.Abstractions;

namespace UtahOpenSource.Droid
{
    [Service (Name="com.xamarin.utahopensource.DataRefreshService", Exported = true, Permission = "com.google.android.gms.permission.BIND_NETWORK_TASK_SERVICE")]
        ...
        public static void ScheduleRefresh (Context context)
        {
            try
            {
                ...
                var pt = new PeriodicTask.Builder ()
                    ...
                    .SetTag ("com.xamarin.utahopensource.backgrounddatarefresh")
                    .SetPersisted (true)
