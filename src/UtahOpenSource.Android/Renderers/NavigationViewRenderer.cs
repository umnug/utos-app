...
[assembly: ExportRenderer (typeof(UtahOpenSource.Clients.UI.NavigationView), typeof(NavigationViewRenderer))]
namespace UtahOpenSource.Droid
{
    public class NavigationViewRenderer : ViewRenderer<UtahOpenSource.Clients.UI.NavigationView, NavigationView>
    {
        NavigationView navView;
        ImageView profileImage;
        TextView profileName;
        protected override void OnElementChanged(ElementChangedEventArgs<UtahOpenSource.Clients.UI.NavigationView> e)
        {
        ...
        void NavigateToLogin()
        {
            ...
            UtahOpenSource.Clients.UI.App.Logger.TrackPage(AppPage.Login.ToString(), "navigation");
        ...
        void NavView_NavigationItemSelected (object sender, NavigationView.NavigationItemSelectedEventArgs e)
        {
            ...
            this.Element.OnNavigationItemSelected(new UtahOpenSource.Clients.UI.NavigationItemSelectedEventArgs
                {
